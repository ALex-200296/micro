...
const initialState: ILogisticsState = {
  [LogisticsComputedPropertyState.storageAssortment]: structuredClone(defaultReportsState),
  [LogisticsComputedPropertyState.goodsStatus]: structuredClone(defaultReportsState),

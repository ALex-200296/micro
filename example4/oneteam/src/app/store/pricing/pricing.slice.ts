...
const initialState: Record<keyof typeof PricingComputedPropertyState, IDefaultReportsState> = {
  [PricingComputedPropertyState.priceLoad]: structuredClone(defaultReportsState),
  [PricingComputedPropertyState.pricelistLoad]: structuredClone(defaultReportsState),
  [PricingComputedPropertyState.discountsLoad]: structuredClone(defaultReportsState),
};

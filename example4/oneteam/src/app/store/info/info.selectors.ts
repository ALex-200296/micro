...
export const infoSelectors = {
  ...
  getInfoParams: (
    ...
    type: (typeof InfoParamsType)[keyof typeof InfoParamsType] = InfoParamsType.noType,
    group: (typeof InfoParamsGroup)[keyof typeof InfoParamsGroup] = InfoParamsGroup.noGroup,
  ...
  getInfoSearch: (
    ...
    term: (typeof TermInfoSearch)[keyof typeof TermInfoSearch] = TermInfoSearch.noTerm,
  ...
  getInfoSesSearch: (type: (typeof TypeInfoSesSearch)[keyof typeof TypeInfoSesSearch] = TypeInfoSesSearch.rManuf) =>

...
const initialState: ICatalogState = {
  [CatalogComputedPropertyState.goodsLoad]: structuredClone(defaultReportsState),
  [CatalogComputedPropertyState.imagesLoad]: structuredClone(defaultReportsState),
  [CatalogComputedPropertyState.newGoodsLoad]: structuredClone(defaultReportsState),
  [CatalogComputedPropertyState.certificatesLoad]: structuredClone(defaultReportsState),
  [CatalogComputedPropertyState.descriptionLoad]: structuredClone(defaultReportsState),
  [CatalogComputedPropertyState.techInfoLoad]: structuredClone(defaultReportsState),
  [CatalogComputedPropertyState.priceLoad]: structuredClone(defaultReportsState),
  [CatalogComputedPropertyState.analogLoad]: structuredClone(defaultReportsState),
  [CatalogComputedPropertyState.constructorLoad]: structuredClone(defaultReportsState),
  [CatalogComputedPropertyState.sametypeLoad]: structuredClone(defaultReportsState),
  ...
  goodsList: {
    listStatus: NoIndexChecks.notChecked,
    data: [],
    records: 0,
    page: 1,
    rows: 10,
    ...
    filters: {
      [goodsListFilters.noIndex]: false,
...
const catalogSlice = createSlice({
  ...
  reducers: {
    ...
    setReportsUpdate: (state, action: PayloadAction<keyof typeof CatalogComputedPropertyState>) => {
    ...
    resetReportsData: (state, action: PayloadAction<keyof typeof CatalogComputedPropertyState>) => {
    ...
    resetReportsFilters: (state, action: PayloadAction<keyof typeof CatalogComputedPropertyState>) => {
    ...
    setGoodsListStatus: (state, action: PayloadAction<keyof typeof NoIndexChecks>) => {

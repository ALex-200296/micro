...
const EventForm: React.FC<IEventFormProps> = ({
  ...
  return (
    ...
    >
      ...
      <FormItem {...formItemsProps[EventKeys.SUB_THEME]}>
        <Select options={subThemeOptions} labelInValue disabled={disabledFields?.[EventKeys.SUB_THEME]} />
      </FormItem>
      ...
      <FormItem {...formItemsProps[EventKeys.RANGE_TIME]}>
        <TimeRangePicker
      ...
      {visibleFields?.[EventKeys.EXM_MAN_CODE] && (
        <>

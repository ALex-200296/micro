...
export const catalogSelectors = {
  getMissingData: (property: (typeof CatalogComputedPropertyState)[keyof typeof CatalogComputedPropertyState]) =>
    createSelector(selectCatalogSlice, (catalogStore) => catalogStore[property].missingData),
  getCatalogFiltersCount: (
    property: (typeof CatalogComputedPropertyState)[keyof typeof CatalogComputedPropertyState],
  ) =>
  ...
  getCatalogTableData: (property: (typeof CatalogComputedPropertyState)[keyof typeof CatalogComputedPropertyState]) =>
    createSelector(selectCatalogSlice, (catalogStore) => catalogStore[property].loadedData.data),
  getCatalogActionsData: (property: (typeof CatalogComputedPropertyState)[keyof typeof CatalogComputedPropertyState]) =>
    createSelector(selectCatalogSlice, (catalogStore) => ({

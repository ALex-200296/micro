...
import { IProjectState, ProjectFiltersType, ProjectsComputedProperty } from './project.types';

export const projectSliceName = 'project';

const initialState: IProjectState = {
  [ProjectsComputedProperty.PROJECT_REQUESTS]: {
    selectedProjectId: '',
    projectsData: {
      page: 1,
      rows: 10,
...
const projectSlice = createSlice({
  ...
  reducers: {
    ...
    resetProjectFilter: (state, action: PayloadAction<ProjectFiltersType>) => {

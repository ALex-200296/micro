...
export const InvoiceProcedure = {
  [InvoiceOperations.MERCH_ACCEPT]: '40105512',
  [InvoiceOperations.MERCH_REJECT]: '40105511',
  [InvoiceOperations.MERCH_SHIPMENT]: '40105510',
  [InvoiceOperations.MERCH_SPLIT]: '40109121',
  [InvoiceOperations.MERCH_1C]: '40108035',
  [InvoiceOperations.PRINT_ACT]: '40048481',
  [InvoiceOperations.DOWNLOAD_UPD]: '40048118',
  [InvoiceOperations.UPDATE_CDK]: '40109047',
  [InvoiceOperations.LABEL_PRINT]: '20048003',
  [InvoiceOperations.MERCH_KDK]: '',
  [InvoiceOperations.MERCH_PRINT_LABEL]: '',
  [InvoiceOperations.MERCH_SHIP_KDK]: '40105614',
} as const;
...
export interface IReturnAdapterRowsInvoices {
  ...
  orderNum: string;
  statusCode: string;
  operations: Record<(typeof InvoiceOperations)[keyof typeof InvoiceOperations], boolean>;
}
